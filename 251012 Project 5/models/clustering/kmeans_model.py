...
# Configuration constants (replaced config.py)
KMEANS_N_CLUSTERS = 5
KMEANS_SVD_THRESHOLD = 20000
KMEANS_SVD_COMPONENTS = 2000
ENABLE_RAPIDS_CUML = True
RAPIDS_FALLBACK_TO_CPU = True
RAPIDS_AUTO_DETECT_DEVICE = True
