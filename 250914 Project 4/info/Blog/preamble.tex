...
\usepackage{fontspec}
\setmainfont{Liberation Serif}[Mapping=tex-text]
\setsansfont{Liberation Sans}[Mapping=tex-text]
...
\usetikzlibrary{shapes,arrows,positioning,shapes.geometric,shapes.symbols}
