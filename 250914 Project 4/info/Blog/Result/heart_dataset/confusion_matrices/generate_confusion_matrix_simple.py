...
class ConfusionMatrixGenerator:
    ...
    def process_all_models(self) -> Dict[str, Any]:
        ...
        # Danh sách các models cần xử lý
        models_to_process = [
...
def main():
    ...
    if results:
        ...
        report_lines = []
        report_lines.append("# Confusion Matrix Thuc Te - Heart Disease Dataset")
        report_lines.append("")
        report_lines.append("## Tong Quan")
        report_lines.append("- **Dataset**: Heart Disease Dataset (heart.csv)")
        report_lines.append("- **Test samples**: 103 samples")
