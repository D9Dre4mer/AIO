...
def test_with_app_pipeline(df: pd.DataFrame, text_column: str, label_column: str) -> Dict[str, Any]:
    ...
    try:
        ...
        step1_data = {
            ...
            # Add dataset metadata for cache compatibility
            'dataset_info': {
                'name': 'spam_ham_dataset',
                'source_file': 'data/2cls_spam_text_cls.csv',
        ...
        step3_data = {
            ...
            # Add vectorization method for cache compatibility
            'vectorization_method': 'TF-IDF'  # Default method for cache key
        }
        ...
        model_key = model_name
        dataset_id = f"spam_ham_dataset_{vectorization_method}"  # Same format as app.py
        config_hash = cache_manager.generate_config_hash({
            'model': model_name,
