"""
Simple Knowledge Distillation Training Script.

Tự động train Model 1 (base teacher) rồi dùng Model 1 để distil cho Model 2:
Model 1 (ViT-Large, no distillation) → Model 2 (ViT-Base, learns from Model 1)
"""
...
def main():
    """Main function to run Model 1 → Model 2 distillation training."""
    print("="*80)
    print("Knowledge Distillation Training: Model 1 → Model 2")
    print("="*80)
    print("\nTraining Order:")
    print("  Model 1 (Base Teacher) → Model 2 (Student)")
    print("\nKnowledge Chain:")
    print("  Model 1 (ViT-Large, no distillation)")
    print("    ↓")
    print("  Model 2 (ViT-Base, learns from Model 1)")
    print("\n" + "="*80)
    ...
    for idx, model_id in enumerate(TRAINING_ORDER):
        ...
        # Check teacher dependencies from config
            ...
            if use_distillation:
                ...
                if teacher_checkpoints:
                    ...
                    if not teacher_checkpoint_path.exists():
                        ...
                        print(f"   Please train Model 1 first!")
                        print(f"   Expected training order: Model 1 → Model 2")
